<!--
    This is the vue component of Piano Keyboard UI for Computer Keyboard UI input.

    It has only slightly more than an octave (referencing the keyboard Input method on Logic Pro X).
-->
